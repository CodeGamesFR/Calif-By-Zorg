...
function addContact(display, num) 
	_TriggerServerEvent('gcPhone:addContact', display, num)
end

function deleteContact(num) 
	_TriggerServerEvent('gcPhone:deleteContact', num)
end
...
function sendMessage(num, message)
	_TriggerServerEvent('gcPhone:sendMessage', num, message)
end

function deleteMessage(msgId)
	_TriggerServerEvent('gcPhone:deleteMessage', msgId)
...
function deleteMessageContact(num)
	_TriggerServerEvent('gcPhone:deleteMessageNumber', num)
end

function deleteAllMessage()
	_TriggerServerEvent('gcPhone:deleteAllMessage')
end

function setReadMessageNumber(num)
	_TriggerServerEvent('gcPhone:setReadMessageNumber', num)
	for k, v in ipairs(messages) do 
...
function requestAllMessages()
	_TriggerServerEvent('gcPhone:requestAllMessages')
end

function requestAllContact()
	_TriggerServerEvent('gcPhone:requestAllContact')
end
...
function startCall(phone_number, rtcOffer, extraData)
	_TriggerServerEvent('gcPhone:startCall', phone_number, rtcOffer, extraData)
end

function acceptCall(infoCall, rtcAnswer)
	_TriggerServerEvent('gcPhone:acceptCall', infoCall, rtcAnswer)
end

function rejectCall(infoCall)
	_TriggerServerEvent('gcPhone:rejectCall', infoCall)
end

function ignoreCall(infoCall)
	_TriggerServerEvent('gcPhone:ignoreCall', infoCall)
end

function requestHistoriqueCall()
	_TriggerServerEvent('gcPhone:getHistoriqueCall')
end

function appelsDeleteHistorique(num)
	_TriggerServerEvent('gcPhone:appelsDeleteHistorique', num)
end

function appelsDeleteAllHistorique()
	_TriggerServerEvent('gcPhone:appelsDeleteAllHistorique')
end
...
RegisterNUICallback('onCandidates', function(data, cb)
	_TriggerServerEvent('gcPhone:candidates', data.id, data.candidates)
	cb()
end)
...
RegisterNUICallback('sendMessage', function(data, cb)
	...
	_TriggerServerEvent('gcPhone:sendMessage', data.phoneNumber, data.message)
end)
...
RegisterNUICallback('addContact', function(data, cb)
	_TriggerServerEvent('gcPhone:addContact', data.display, data.phoneNumber)
end)

RegisterNUICallback('updateContact', function(data, cb)
	_TriggerServerEvent('gcPhone:updateContact', data.id, data.display, data.phoneNumber)
end)

RegisterNUICallback('deleteContact', function(data, cb)
	_TriggerServerEvent('gcPhone:deleteContact', data.id)
end)
...
RegisterNUICallback('deleteALL', function(data, cb)
	_TriggerServerEvent('gcPhone:deleteALL')
	cb()
end)
...
AddEventHandler('onClientResourceStart', function(res)
	...
	if res == "gcphone" then
		_TriggerServerEvent('gcPhone:allUpdate')
	end
end)

...
AddEventHandler('esx_shops:buyItem', function(itemName, amount, zone)
	...
	if xPlayer.getAccount('cash').money >= price then
		...
		TriggerClientEvent('esx:showNotification', _source, _U('not_enough', ESX.Math.GroupDigits(price - xPlayer.getAccount('cash').money)))
	end
end)

RegisterServerEvent('esx_shops:pickUp')
AddEventHandler('esx_shops:pickUp', function(store)

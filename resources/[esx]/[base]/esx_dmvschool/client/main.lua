...
function StartTheoryTest()
	...
	_TriggerServerEvent('esx_dmvschool:pay', Config.Prices['dmv'])
...
function StopTheoryTest(success)
	...
	if success then
		_TriggerServerEvent('esx_dmvschool:addLicense', 'dmv')
...
function StartDriveTest(type)
	...
	_TriggerServerEvent('esx_dmvschool:pay', Config.Prices[type])
end

function StopDriveTest(success)
	if success then
		_TriggerServerEvent('esx_dmvschool:addLicense', CurrentTestType)
		ESX.ShowNotification(_U('passed_test'))
	else
		ESX.ShowNotification(_U('failed_test'))
	end
